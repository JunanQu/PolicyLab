...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="NewStyle.css" media="all" />
  ...
  <body onload="enableButton();">
    ...
    <div class="wrapper" id="consent">
        ...
        <p>
         ...
         Only the researchers will have access to the records. The records will not contain 
         ...
         If you have any questions about this research, you may reach Dr. Macy by email at mwm14@cornell.edu.
         </p>
       ...
       <form method="post">
       <p><input type="checkbox" id="myCheck" onclick="javascript:enableButton();" >  I have read the above 
       information and consent to take part in the study.<br></p>
       
    
     <input type = "button"  class="button" id = "myButton" value = "I consent to participate" onclick="javascript:enableButton();">
